...
positive_sample_files = positive_sample_files[:50000]
...
# negative_sample_files = negative_sample_files[:10000]
...
for epoch in range(NB_EPOCHS):
    ...
    torch.save(policy.state_dict(), 'data/trained_params_gnn5.pkl')