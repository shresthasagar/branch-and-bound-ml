...
if __name__ == '__main__':
    ...
    ######### Uncomment below to run oracle method #####################
    ...
    #     H = instances[i,0,:,:] + 1j*instances[i,1,:,:]
    #     obj_bb += optimal_objective_list[i]
    #     obj_omar += as_omar(H, max_ant=max_ant)
    #     print(i)
    #     # f, m, total_nodes = enumeration_antenna_selection(H, max_ant)
    #     # obj_opt += f
    #     # print(f,m, total_nodes, (time.time()-t1)/(i+1))
    #     # num_nodes_eval += total_nodes
    # print(obj_bb/num_egs, obj_omar/num_egs)
    # print((obj_omar-obj_bb)/obj_bb*100)
    # print('time', (time.time()-t1)/10, num_nodes_eval/10)
